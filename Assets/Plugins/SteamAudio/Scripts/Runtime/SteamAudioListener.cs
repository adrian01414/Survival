...
namespace SteamAudio
{
    ...
    public class SteamAudioListener : MonoBehaviour
    {
        ...
        public void BeginBake()
        {
            ...
            tasks[0].probeBatches = (useAllProbeBatches) ? FindObjectsByType<SteamAudioProbeBatch>(FindObjectsInactive.Include, FindObjectsSortMode.InstanceID) : probeBatches;
        ...
        {
            mProbeBatchesUsed = (useAllProbeBatches) ? FindObjectsByType<SteamAudioProbeBatch>(FindObjectsInactive.Include, FindObjectsSortMode.InstanceID) : probeBatches;
        }
#endif
    }
}